 ...
 * @info: struct that contains the potential arguments. Used for  maintaining
...
/**
 * _mycd - to change the current path of the process
...
/**
 * _myhelp - this will change the current path of the process
